 ...
 */
goog.provide('forms.controls.TextInput');
...
goog.require('forms.controls.TextInputRenderer');
 ...
 * @param {forms.controls.TextInputRenderer=} opt_renderer Renderer used to render or
 ...
 */
forms.controls.TextInput = function (content, opt_renderer, opt_domHelper) {
	forms.controls.TextInput.base(this, 'constructor', content, opt_renderer ||
		forms.controls.TextInputRenderer.getInstance(), opt_domHelper);
...
goog.inherits(forms.controls.TextInput, goog.ui.Control);

/** @inheritDoc */
forms.controls.TextInput.prototype.decorateInternal = function (el) {
	forms.controls.TextInput.base(this, 'decorateInternal', el);
...
/** @inheritDoc */
forms.controls.TextInput.prototype.enterDocument = function () {
	forms.controls.TextInput.base(this, 'enterDocument');
 ...
 * @param {Object} config
 */
forms.controls.TextInput.prototype.setConfig = function (config) {
/*
 ...
 * @return {*}
 */
forms.controls.TextInput.prototype.getValue = function () {
 ...
 * @param {*} value
 */
forms.controls.TextInput.prototype.setValue = function (value) {
 ...
 * @private
 */
forms.controls.TextInput.prototype.fireChangeEvent_ = function () {
 ...
 * @private
 */
forms.controls.TextInput.prototype.handleKeyDown_ = function (e) {
 ...
 * @private
 */
forms.controls.TextInput.prototype.handleKeyUp_ = function (e) {
...
goog.ui.registry.setDecoratorByClassName(
  forms.controls.TextInputRenderer.CSS_CLASS,
  function() {
    return new forms.controls.TextInput(' ');
  });
